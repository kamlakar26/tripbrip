...
- (void)viewDidLoad
{
    ...
    if (self){
       ...
       // self.view.backgroundColor=[UIColor redColor];
        ...
        contentView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"background2.png"]];
        ...
        //CGRect view = CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height - [[self navigationController] navigationBar].bounds.size.height - statusBarSize.height-50);
        CGRect view = CGRectMake(0, 100,self.view.bounds.size.width,320);
