...
@interface completedViewController1 : PUUIBaseVC
...
@property (strong, nonatomic) IBOutlet UITextView *pickupaddlab;
...
@property(nonatomic,retain)NSString *Useridpass;
...
@property(nonatomic,retain)NSString *passpaymentstuts;
@property(nonatomic,retain)NSString *passwallet;
...
@property (strong, nonatomic) IBOutlet UILabel *wallet;
